...
var wordsList = ["galaxy", "planet", "star", "asteroid", "comet", "orion", "universe", "gravity", "moon","infinity"];
...
//Alerts user if they win
var winner = "YOU WIN!"

//Alerts user if they lose
var loser = "YOU LOSE!"

//Alerts user the next game is about to begin
var nextGame = "Get Ready For The Next Word";
...
function startGame() {
  ...
  //resets the message-txt
  document.getElementById("message-txt").innerHTML = "";

  //resets the id end-txt
...
function roundComplete() {
  ...
  if (lettersInChosenWord.toString() === blanksAndSuccesses.toString()) {
    ...
    //Gives user a win message
    document.getElementById("message-txt").innerHTML = winner;

    //Populate html that new game is about to begin
    document.getElementById("end-txt").innerHTML = nextGame;

    //restarts game after 3 seconds
  ...
  // If we've run out of guesses
    ...
    //Gives user a lose message
    document.getElementById("message-txt").innerHTML = loser;
